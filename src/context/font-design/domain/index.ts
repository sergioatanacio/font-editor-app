...
export { TypefaceId } from "./value-objects/TypefaceId";
export { GlyphId } from "./value-objects/GlyphId";
export { GlyphName } from "./value-objects/GlyphName";
export { UnicodeCodePoint } from "./value-objects/UnicodeCodePoint";
export { GlyphMetrics } from "./value-objects/GlyphMetrics";
